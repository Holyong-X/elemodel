...
public class RoadController {
    ...
    @Autowired
    private RoadService targetService;
    ...
    */
    ...
    public ResponseResult list(@ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @PathVariable Long limit,
                               @RequestBody(required = false) Road entity) {
        Page<Road> pageParam = new Page<>(current, limit);
    ...
    */
    ...
    public ResponseResult findAll() {
        List<Road> list = targetService.list();
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        Road entity = targetService.getById(id);
    ...
    public ResponseResult getByCondition(@RequestBody Road road) {
        QueryWrapper<Road> queryWrapper =new QueryWrapper<>();
        queryWrapper.eq("SMID",road.getSmid());
        Road entity = targetService.getOne(queryWrapper);
        return ResponseResult.ok().data("result",entity);
    }
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody Road entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody Road entity) {
