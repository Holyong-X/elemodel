...
public class HouseController {
    ...
    */
    ...
    public ResponseResult list(@ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) House entity) {
        Page<House> pageParam = new Page<>(current, limit);
    ...
    */
    ...
    public ResponseResult findAll() {
        List<House> list = targetService.list();
    ...
    public ResponseResult getByCondition(@RequestBody House house) {
        QueryWrapper<House> queryWrapper =new QueryWrapper<>();
        queryWrapper.eq("SMID",house.getSmid());
        House entity = targetService.getOne(queryWrapper);
        return ResponseResult.ok().data("result",entity);
    }
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody House entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody House entity) {
