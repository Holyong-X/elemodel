...
public class ForestController {
    ...
    @Autowired
    private ForestService targetService;
    ...
    */
    ...
    public ResponseResult list(@ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @PathVariable Long limit,
                               @RequestBody(required = false) Forest entity) {
        Page<Forest> pageParam = new Page<>(current, limit);
        QueryWrapper<Forest> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<Forest> list = targetService.list();
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        Forest entity = targetService.getById(id);
    ...
    public ResponseResult getByCondition(@RequestBody Forest forest) {
        QueryWrapper<Forest> queryWrapper =new QueryWrapper<>();
        queryWrapper.eq("SMID",forest.getSmid());
        Forest entity = targetService.getOne(queryWrapper);
        return ResponseResult.ok().data("result",entity);
    }
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody Forest entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody Forest entity) {
